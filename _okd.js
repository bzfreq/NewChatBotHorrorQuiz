    ...
    if (type === 'bot') {
        if (isLoading) {
            ...
            if (movieToDisplay && movieToDisplay.poster) {
                ...
                // Add action buttons - NOW WITH 4TH BUTTON
                content += `
...
function updateMovieSections(movieDetails, recommendations) {
    // Update streaming section with movie info
        ...
        <div class="bg-gray-800 rounded-lg p-3 border border-gray-600">
            <div class="flex items-center space-x-3">
                ...
                <div class="flex-1">
                    ...
                    <button onclick="watchTrailer('${movieDetails.title}')" 
                            class="w-full mt-2 px-2 py-1 bg-red-600 text-white text-xs rounded hover:bg-red-700 transition-colors">
                        🎬 Watch Trailer
                    </button>
                </div>
            </div>
